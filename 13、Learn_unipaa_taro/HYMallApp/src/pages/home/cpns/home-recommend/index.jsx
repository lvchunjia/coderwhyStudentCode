  ...
  return (
    <View className={styles["recommend"]}>
      <Image
        ...
        mode="widthFix"
        onClick={() => handleItemClick(recommend.ad_big_top.link)}
      ></Image>
      ...
      <View className={styles["recommend-item"]}>
        <Image
          ...
          mode="widthFix"
          onClick={() => handleItemClick(recommend.ad_left.link)}
        ></Image>
        ...
        <View className={styles["ad-right"]}>
          <Image
            ...
            mode="widthFix"
            onClick={() => handleItemClick(recommend.ad_right1.link)}
          ></Image>
          <Image
            className={styles["ad-right-pic2"]}
            src={recommend.ad_right2.pic}
            mode="widthFix"
            onClick={() => handleItemClick(recommend.ad_right2.link)}
          ></Image>
        </View>
      </View>

      <Image
        className="ad-big-top-pic"
        src={recommend.ad_big_bottom.pic}
        mode="widthFix"
        onClick={() => handleItemClick(recommend.ad_big_bottom.link)}
      ></Image>
      <Image
        className="ad-big-top-pic"
        src={recommend.choiceness.pic}
        mode="widthFix"
        onClick={() => handleItemClick(recommend.choiceness.link)}
      ></Image>
    </View>
  );
});
