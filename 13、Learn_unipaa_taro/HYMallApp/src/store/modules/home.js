...
// 异步的action
export const getHomeInfoThunkAction = createAsyncThunk(
  "home/info",
  async () => {
...
export const getRecommendThunkAction = createAsyncThunk(
  "home/recommend",
  async () => {
...
export const getGoodsThunkAction = createAsyncThunk(
  "home/goods",
  async payload => {
